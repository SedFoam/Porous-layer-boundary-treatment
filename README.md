...
The python package fluidfoam is required for running the post-processing codes. Deployment instructions can be found here: https://fluidfoam.readthedocs.io/en/latest/.
