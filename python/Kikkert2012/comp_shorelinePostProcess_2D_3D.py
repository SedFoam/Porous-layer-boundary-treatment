...
sauvegarde = True
titre_sauv = "shorelineMoyenneGlissantePostProcess_rug13_2D_3D"
...
for ind_path, path in enumerate(paths):
    ...
    if not os.path.exists(
        path + "netcdf\\shoreline.nc"
    ):  # if the shoreline was not saved yet
        ...
        SL = list_intersec_num[:, 0]

    else:  # if the shoreline was already saved
