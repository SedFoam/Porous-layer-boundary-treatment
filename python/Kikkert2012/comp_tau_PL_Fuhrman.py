...
sauvegarde = False
titre_sauv = "Friction_parietale_tau_rug13_CP_Fuhrman_log"
...
YLim = np.array([[0.03, 50], [0.03, 50], [0.03, 50], [0.03, 50], [0.03, 50]])
...
for probeNum, probe_name in enumerate(probe_names):
    ...
    # plt.scatter(t, Tau3, color='blue', marker='s', label="Données expérimentales")
    plt.scatter(
        t,
        Tau2,
        color="darkorange",
